  ...
  return (
    <section className="serviciosIqea">
      <div className="serviciosHeader">
        ...
        <p>
          La principal especialidad de IQEA dentro del área de servicios son los
          proyectos “llave en mano” para el tratamiento de agua o aguas
        ...
        <div className="serviciosLeft">
          <div className="servicio">
            ...
            <div className="servicioContent">
              ...
              <p>
                Potabilización, Purificación, Filtración fina, Ultrafiltración,
          ...
          <div className="servicio">
            ...
            <div className="servicioContent">
              ...
              <p>
                Biofiltración, Lodos activados, Electrocoagulación, Tratamiento
                fisicoquímico, agua pluvial y terciario.
              </p>
            </div>
          </div>
          <div className="servicio">
            ...
            <div className="servicioContent">
              ...
              <p>
                Riesgo e impacto ambiental, Uso de suelo, Tramites de conexión y
                descargade agua, Optimización de recursos, Eficiencia de
                procesos
              </p>
            </div>
          </div>
